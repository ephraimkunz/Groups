...
export function create_groups_wasm(students, group_size, output_timezone) {
    ...
    const ret = wasm.create_groups_wasm(students, group_size, ptr0, len0);
    return ret;
}
...
const StudentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_student_free(ptr >>> 0, 1));
/**
...
export class Student {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        StudentFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        StudentFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_student_free(ptr, 0);
    }
    /**
     ...
     */
    static new(name, timezone, availability) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(timezone, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(availability, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.student_new(ptr0, len0, ptr1, len1, ptr2, len2);
    ...
    encode() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.student_encode(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    availability_in_timezone(timezone) {
        const ptr0 = passStringToWasm0(timezone, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.student_availability_in_timezone(this.__wbg_ptr, ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
    ...
    name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.student_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    timezone() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.student_timezone(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('groups_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
